              ...
              <div className="flex items-center gap-3">
                ...
                {!readOnly && (
                  <button
                    ...
                    className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-rose-100 text-sm font-semibold text-rose-700 shadow-sm transition hover:bg-rose-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-200 dark:bg-rose-900/40 dark:text-rose-100 dark:hover:bg-rose-900/60"
