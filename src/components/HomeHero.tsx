        ...
        <div className="relative mt-4 grid gap-12 lg:grid-cols-[1.1fr_minmax(0,0.9fr)]">
          <div className="space-y-10">
            <div className="inline-flex items-center gap-2 rounded-full border border-brand-500/20 bg-white/90 px-4 py-2 text-sm font-medium text-brand-700 shadow-sm backdrop-blur dark:border-emerald-900/60 dark:bg-slate-950/80 dark:text-brand-200">
              ...
              Ieeja’s fastest farm-to-home groceries
            </div>
            <div className="max-w-xl space-y-6">
              <h1 className="font-display text-4xl font-semibold text-emerald-950 sm:text-5xl dark:text-brand-50">
                Dinner plans? We handpick & deliver groceries the same day.
              </h1>
              <p className="text-lg text-slate-600 dark:text-slate-200">
                Browse seasonal produce, pantry staples, and local favourites. Schedule a delivery window and we’ll do the rest.
              </p>
            </div>
          ...
          <div className="rounded-3xl border border-emerald-100/70 bg-white/80 p-6 shadow-xl shadow-brand-900/10 backdrop-blur dark:border-emerald-900/50 dark:bg-slate-900/70">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
              Fresh arrivals curated from local farmers, dairies, and suppliers. Add them straight to your basket in Discover.
            </p>
            ...
            <div className="mt-6 rounded-2xl border border-brand-100/70 bg-brand-500/10 px-4 py-3 text-xs font-medium text-brand-700 dark:border-brand-700/40 dark:bg-brand-900/20 dark:text-brand-200">
              Delivery windows: 11:30 AM • 6:30 PM. Place your order at least 45 minutes before the slot.
            </div>
          </div>
        </div>
      </div>
