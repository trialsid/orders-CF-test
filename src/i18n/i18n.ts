...
const translations = {
  en: {
    ...
    cart: {
      ...
      confirmationNote:
        'After you submit, we call within 5 minutes to confirm slot and total. Payment currently accepted in cash or UPI on delivery.',
      aria: {
    ...
    checkout: {
      ...
      forms: {
        ...
        slotPlaceholder: 'Morning 11:30 AM',
        paymentLabel: 'Payment method',
        paymentPlaceholder: 'UPI on delivery',
  ...
  te: {
    ...
    cart: {
      ...
      placingOrder: 'ఆర్డర్ పంపిస్తున్నాం…',
      confirmationNote:
        'సబ్మిట్ చేసిన తర్వాత 5 నిమిషాల్లో మేము కాల్ చేసి స్లాట్, మొత్తం నిర్ధారిస్తాం. ప్రస్తుతం చెల్లింపు డెలివరీ సమయంలో నగదు లేదా యూపీఐ.',
      aria: {
    ...
    checkout: {
      ...
      forms: {
        ...
        slotPlaceholder: 'ఉదయం 11:30',
        paymentLabel: 'చెల్లింపు విధానం',
        paymentPlaceholder: 'డెలివరీపై యూపీఐ',
